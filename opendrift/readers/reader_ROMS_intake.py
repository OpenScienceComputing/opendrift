...
class Reader(BaseReader, StructuredReader):
    ...
    def __init__(self, intake_catalog=None, dataset=None, name=None, gridfile=None, standard_name_mapping={}):

        if intake_catalog is None:
            raise ValueError('Need intake_catalog as argument to constructor')
            
        if dataset is None:
            raise ValueError('Need dataset as argument to constructor')
